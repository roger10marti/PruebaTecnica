...
interface SeriesApiClient {
    ...
    @GET("tv/popular?api_key=c6aeee577586ba38e487b74dfede5deb&language=en-US")
    suspend fun getAllSeries(@Query("language") language: String, @Query("page") page: Int): Response<Generic>

    @GET("tv/popular?api_key=c6aeee577586ba38e487b74dfede5deb&language=en-US&page=1")
    suspend fun getTotalPages(): Response<Generic>
}